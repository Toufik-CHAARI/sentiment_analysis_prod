...
class TestSentimentService:
    ...
    def test_init_success(self, mock_pickle_load, mock_open, mock_tokenizer, mock_load_model):
    ...
    @patch('builtins.open')
    @patch('app.services.sentiment_service.pickle.load')
    def test_predict_sentiment_success(self, mock_pickle_load, mock_open, mock_tokenizer, mock_load_model):
    ...
    @patch('builtins.open')
    @patch('app.services.sentiment_service.pickle.load')
    def test_predict_sentiment_negative(self, mock_pickle_load, mock_open, mock_tokenizer, mock_load_model):
