...
class TestPerformance:
    ...
    def test_prediction_speed(self, mock_pickle_load, mock_open, mock_tokenizer, mock_load_model):
    ...
    @patch('builtins.open')
    @patch('app.services.sentiment_service.pickle.load')
    def test_multiple_predictions(self, mock_pickle_load, mock_open, mock_tokenizer, mock_load_model):
